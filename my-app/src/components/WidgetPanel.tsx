...
import { Activity, Brain, Bell, Megaphone, X, Columns2, Rows3, TrendingUp, BarChart3 } from "lucide-react";
...
function SingleWidget({
  ...
  return (
    <div
      className={cn(
        "flex flex-col bg-gradient-to-br from-teal-500/10 via-background/95 to-purple-600/10 backdrop-blur-xl border border-teal-500/30 rounded-xl shadow-2xl overflow-hidden flex-shrink-0",
        isStacked ? "w-full flex-1 min-h-0" : "w-64 h-full"
      )}
    >
      {/* Header */}
      <div className="flex items-center justify-between px-3 py-2 border-b border-teal-500/20 bg-gradient-to-r from-teal-500/15 to-purple-600/15">
